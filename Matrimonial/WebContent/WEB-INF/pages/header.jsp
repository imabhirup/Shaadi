...
<body>
	...
	<div class="bs-component">
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary"> <a
			class="navbar-brand" href="${contextPath }/homepage"><img
			alt="Shaadi Logo" src=""></a>
		...
		<div class="collapse navbar-collapse mr-sm-2" id="navbarColor01">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active login"><a data-toggle="modal"
					href="#logInModal" class="nav-link">Login <span class="sr-only">(current)</span></a>

				</li>
				<li class="nav-item"><a data-toggle="modal" class="nav-link"
					href="#registerInModal">Register</a></li>
				<li class="nav-item"><a class="nav-link" href="#">Search
						Options</a></li>
				<li class="nav-item"><a class="nav-link" href="#">Membership</a>
				</li>
